...
local function mode_name()
  ...
  vim.api.nvim_command("hi PandaLineViMode guibg=" .. mode_info.color .. " guifg=" .. "#282c34")
  return name
end
...
function FileName(win)
  ...
  local show_name = "%#PandaLineFile#" .. util.get_name(file_name) .. "%m" .. "%##"
  if icon_info ~= nil then
    ...
    return "%#" .. icon_hl_group .. "#" .. icon_info.symbol .. "%##" .. FileSpace() .. show_name
  end
  return show_name
end
